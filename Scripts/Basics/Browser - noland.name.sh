...
WEBPAGE=\
http://www.noland.name
http://www.hashbytes.com/HelloSpring/
www.bouldervolleyball.org

http://www.noland.name/Mobile
http://www.noland.name/BBSQL.jsp?State=CO
/Volumes/MYLIBRARY/Projects/HTML_Experiments/HTML_Experiments/webpages/GeoLocation.html
